...
* Added the ability for the user to see the amount of likes and retweets on a tweet
...
<img src='https://github.com/AndresM77/MySimpleTweets/blob/master/Proj3Video.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
